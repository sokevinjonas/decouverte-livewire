<div class="container mx-auto py-16 px-8">
    <div class="mb-4">
        <input type="text" wire:model.live="search" placeholder="Rechercher des produits">
    </div>
    <table class="table-auto w-full">
        <thead>
            <tr>
                ...
                <th class="py-2 px-3 bg-gray-100 border-b-2 text-left">Titre</th>
                <th class="py-2 px-3 bg-gray-100 border-b-2 text-left">Prix</th>
            </tr>
        </thead>
        <tbody>
